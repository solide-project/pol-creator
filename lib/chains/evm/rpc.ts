...
export const data: { [key: string]: string } = {
    ...
    [ChainID.MOONBEAM_MAINNET]: "https://moonbeam.drpc.org",
    [ChainID.MOONBASE_ALPHA]: "https://moonbase-alpha.drpc.org",
    [ChainID.MOONRIVER_MAINNET]: "https://moonriver.drpc.org",
